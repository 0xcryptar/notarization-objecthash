...
namespace ObjectHashServer.Controllers
{
    ...
    {
        [HttpPost]
        public ActionResult<ObjectHashResponseModel> Post([FromBody] ObjectBaseRequestModel model, [FromQuery] bool generateSalts = true)
        {
            if (generateSalts && model.Salts == null)
            {
